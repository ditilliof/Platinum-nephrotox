...
model {
  ...
  maxdeath ~ normal(1.295034e+01, 0.5);
  hillDD ~ normal(40.138282925, 2.919770e+00);
  k_hillnec ~ normal(4.078113e+00, 0.360607596);
  d_CD ~ normal(6.063535e-03, 3.084363e-03);
  h1 ~ normal(8, 1);   
  k_CDINF ~ normal(2.000160e-01, 0.1);
  d_INF ~ normal(1.186523e-02, 0.1);
  k_INFKF ~ normal(5.452077e-02, 0.1);
  hillKF ~ normal(1.289326e+01, 2.481339e+00);
